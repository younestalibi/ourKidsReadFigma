...
Route::get('/', function () {
    $firstname='younes';
    $lastname='talibi';
    return view('newdesign.email.ParentRegisterWelcome',compact('firstname','lastname'));
    // return view('newdesign.email.ReaderRegisterWelcome',compact('firstname','lastname'));
