...
class UserController extends Controller
{
    ...
    public function updateStep1(Request $request)
    {
        ...
        DB::table('tbl_user')
            ...
            ->update([
                ...
                'sms_opt_in_flag' => $request->has('sms_opt_in_flag')
            ]);
    ...
    public function trainingVideo(Request $request, $id)
    {
        $data = [
            1 => [
                'video' => asset('newdesign/videos/reading_budies_training_-_welcome1.mp4'),
            ...
            2 => [
                'video' => asset('newdesign/videos/reading_buddies_training_-_student_led_learning4.mp4'),
            ...
            4 => [
                'video' => asset('newdesign/videos/reading_buddies_training_-_getting_to_know_your_student3.mp4'),
